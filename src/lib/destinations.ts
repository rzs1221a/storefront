...
export const DESTINATIONS: Destination[] = [
  {
    ...
    frame: "top",
    label: "Home",
    title: "Stop renting your website — own it outright, from $1,500",
    blurb: `Custom websites BHHS agents own outright: built once, $0 a month, every lead wired straight into BoldTrail. ${CATALOG_TOTALS.options} site types on the menu, ${numberWord(TOTALS.projects).toLowerCase()} sites shipped along this coast as proof.`,
    group: "coast",
    navOrder: 1,
    mobileTab: "Home",
    verifyPhrase: "wired straight into BoldTrail",
  },
  ...workDestinations,
  {
    path: "/options",
