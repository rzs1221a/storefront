...
/* The route-scroll choreography (observeFrames) and hover-to-fly died with
   the global backdrop: the camera now answers only the exhibit's controls —
   the typed deck, the tour, the swipe cards, and beacon clicks. */
